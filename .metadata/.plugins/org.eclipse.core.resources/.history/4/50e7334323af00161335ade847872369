...
public class ReservationC {
	...
	public String toString() {
		return this.GetId() + " - " + this.GetSemaine().GetDateDebut().getDayOfMonth() + "/" + this.GetSemaine().GetDateDebut().getMonthValue() + "/" + this.GetSemaine().GetDateDebut().getYear() + " au " + this.GetSemaine().GetDateFin().getDayOfMonth() + "/" + this.GetSemaine().GetDateFin().getMonthValue() + "/" + this.GetSemaine().GetDateFin().getYear() + " - " + this.GetEleve().GetNom() + " " + this.GetEleve().GetPrenom() + " - " + this.GetCours().GetSport() + " " + this.GetCours().GetCategorieAge() + " " + this.GetCours().GetNiveau() + "(" + this.GetCours().GetTypeCours().GetDenomination() + ") - " + this.GetHoraire().GetHeureDebut() + " à " + this.GetHoraire().GetHeureFin() + " - " + this.GetMoniteur().GetNom() + " - " + this.GetCours().GetPrix()+ "€";
	}
}
